...
(function () {
  ...
  function cortina(alHero) {
    ...
    tl.to(".cortina-cinta", { scaleX: 1, duration: .75, ease: "expo.inOut" })
      .to(".cortina-lote", { opacity: 1, duration: .3, ease: "power2.out" }, "-=.26")
      .to(".cortina-marca", { opacity: 1, duration: .45, ease: "power2.out" }, "-=.2")
      .add(alHero, "+=.12")
      .to(".cortina-centro", { opacity: 0, duration: .3, ease: "power2.in" })
      .set(".cortina-cinta", { transformOrigin: "50% 50%" })
      .to(".cortina-cinta", { scaleX: 0, duration: .5, ease: "expo.inOut" }, "-=.18")
      .to(".cortina-solapa--arr", { yPercent: -101, borderRadius: 0, duration: 1.05, ease: "expo.inOut" }, "-=.3")
      .to(".cortina-solapa--aba", { yPercent: 101, borderRadius: 0, duration: 1.05, ease: "expo.inOut" }, "<");
  }
